...
DATASET_DIR="$ROOT_DIR/dataset/ManiSkill/StackCube-v1/motionplanning"
...
echo "[$(date +%H:%M:%S)] Step 2: Replaying to rgb + pd_ee_delta_pos..."
...
src = '$DATASET_DIR/StackCube.rgb.pd_ee_delta_pos.physx_cpu.h5'
dst = '$DATASET_DIR/StackCube.rgb.pd_ee_delta_pos.physx_cpu.filtered.h5'
max_steps = $MAX_STEPS
target = $TARGET_DEMOS
...
echo "Filtered dataset: $DATASET_DIR/StackCube.rgb.pd_ee_delta_pos.physx_cpu.filtered.h5"
