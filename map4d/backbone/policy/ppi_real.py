...
from map4d.backbone.model.diffusion.diffuser_actor_ppi_real import DiffusionHeadPPIReal
from map4d.backbone.model.diffusion.diffuser_actor_ppi_real_simple import DiffusionHeadPPIRealSimple
